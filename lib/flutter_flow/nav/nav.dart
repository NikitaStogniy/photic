      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => GenerateHolderWidget(
            ...
            packRef: params.getParam(
                'packRef', ParamType.DocumentReference, false, ['aiImage']),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/packPage',
          asyncParams: {
            'pack': getDoc(['aiImage'], AiImageRecord.fromSnapshot),
          },
          builder: (context, params) => PackPageWidget(
            packNum: params.getParam('packNum', ParamType.String),
            pack: params.getParam('pack', ParamType.Document),
          ),
        ),
        FFRoute(
          name: 'settingsPage',
